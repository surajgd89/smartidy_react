      ...
      <div className="page active" id="home">
         <div className="profile">
            ...
            <div className="bottom">
               <a href="#modal-visit" className="visit-us ripple-effect-1">
               ...
               <a href="#modal-forward" className="share-one ripple-effect-1">
         ...
         <div className="home-actions">
            <a href="#modal-call" className="ripple-effect-1">
               <span>
            ...
            <a href="#modal-email" className="ripple-effect-1">
               <span>
            ...
            <a href="#modal-chat" className="ripple-effect-1">
               <span>
            ...
            <a href="#modal-sms" className="ripple-effect-1">
               <span>
