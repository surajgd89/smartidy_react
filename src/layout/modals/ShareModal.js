         ...
         <div className="modal">
            ...
            <div className="modal-body">
               <div className="share-via">
                  <a href="#" id="whatsapp-share" className="share-opt whatsapp "
                  >
                     <i className="fab fa-whatsapp"></i>
                     <span>WhatsApp</span>
                  </a>
                  <a href="#" id="telegram-share" className="share-opt telegram "
                  >
                     <i className="fab fa-telegram"></i>
                     <span>Telegram</span>
                  </a>
                  <a href="#" id="sms-share" className="share-opt sms " >
                     <i className="fa-light fa-comment-alt-lines"></i>
                     <span>SMS</span>
                  </a>
                  <a href="#" id="email-share" className="share-opt email " >
